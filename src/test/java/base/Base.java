...
public class Base {
	...
	@Parameters({ "driverPath", "browser", "url","implicitWait","user","password" })
	public void goHome(ITestResult result, String driverPath, String browser, String url, long implicitWait, String username, String password) throws Exception {
